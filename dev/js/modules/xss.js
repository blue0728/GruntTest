...
var whiteList = {
  ...
  abbr:   ['title','style'],
  address: ['style'],
  area:   ['shape', 'coords', 'href', 'alt', 'target','style'],
  article: ['style'],
  aside:  ['style'],
  ...
  hr:     ['style'],
  i:      ['style'],
  img:    ['src', 'alt', 'title', 'width', 'height','style','border','usemap'],
  input:  ['type','name','value', 'checked', 'style'],
  ins:    ['datetime','style'],
  li:     ['style'],
  map:   ['name', 'style'],
  mark:   ['style'],
